  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // shadcn aliases — backed by the v2 tokens
      ...
      borderRadius: {
        sm: "calc(var(--radius) - 2px)",       // 6px — small icons/chips
        md: "var(--radius)",                   // 8px — buttons, inputs
        lg: "var(--radius-card)",              // 10px — cards
        xl: "var(--radius-card-elevated)",     // 12px — modals, tiles, elevated
        "2xl": "var(--radius-sheet)",          // 16px — sheet top corners
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "red-pulse": "red-pulse 0.6s ease-in-out infinite",
      },
    },
  },
