  ...
  return (
    ...
    >
      ...
      {/* Physical description / Background / Who they know — always
          rendered so the user can see every field slot the schema
          supports. Empty fields show a muted placeholder + "Tap Edit"
          hint instead of being hidden. AI badge only shows when the
          description came from describe-from-photo and is untouched. */}
      <div className="px-5 mb-6 space-y-3">
        ...
        >
          {person.physical_description ? (
            ...
            <p className="text-[13px] font-display-italic text-[hsl(var(--foreground)/0.5)]">
              Empty — tap Edit to add.
            </p>
          )}
        </DetailCard>
